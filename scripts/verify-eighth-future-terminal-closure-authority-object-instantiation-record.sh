...
PREVIOUS_AUTHORITY_SLOT_ID = "outsider_replay_passage_authority"
PREVIOUS_AUTHORITY_OBJECT = "OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"
PREVIOUS_INSTANTIATION_RECORD_ID = "INST_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"

REQUEST_ID = "REQ_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT"
VALIDATION_RECORD_ID = "VAL_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT"
DECISION_RECORD_ID = "DEC_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT"
INSTANTIATION_RECORD_ID = "INST_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT"
AUTHORITY_SLOT_ID = "terminal_closure_authority"
AUTHORITY_OBJECT = "TERMINAL_CLOSURE_AUTHORITY_OBJECT"

PATHS = {
    "law": Path("CINEMATICUM_EIGHTH_FUTURE_TERMINAL_CLOSURE_AUTHORITY_OBJECT_INSTANTIATION_RECORD_LAW.json"),
    "status": Path("CASES/CASE_001_THE_LAST_RENDER/EIGHTH_FUTURE_TERMINAL_CLOSURE_AUTHORITY_OBJECT_INSTANTIATION_RECORD_STATUS.json"),
    "request": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_REQUESTS/REQ_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT.json"),
    "validation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_VALIDATION_RECORDS/VAL_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT.json"),
    "decision": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_DECISION_RECORDS/DEC_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT.json"),
    "instantiation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_INSTANTIATION_RECORDS/INST_008_TERMINAL_CLOSURE_AUTHORITY_OBJECT.json"),
    "authority_object": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECTS/TERMINAL_CLOSURE_AUTHORITY_OBJECT.json"),
    "previous_instantiation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_INSTANTIATION_RECORDS/INST_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
    "previous_authority_object": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECTS/OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
}
...
if not bool_value(docs["previous_authority_object"], ["outsider_replay_passage_locked"], default=False):
    raise SystemExit("previous outsider replay passage is not locked")
if not bool_value(docs["previous_authority_object"], ["outsider_replay_passed_for_future_authority_snapshot"], default=False):
    raise SystemExit("previous outsider replay passage is not passed for future authority snapshot")
...
checks_true = {
    ...
    "outsider_replay_passage_dependency_satisfied": bool_value(docs["authority_object"], ["outsider_replay_passage_dependency_satisfied"], default=True),
    "terminal_closure_dependency_satisfied": bool_value(docs["authority_object"], ["terminal_closure_dependency_satisfied"], default=True),
    "terminal_closure_authority_locked": bool_value(docs["authority_object"], ["terminal_closure_authority_locked"], default=True),
    "terminal_closure_locked_for_future_authority_snapshot": bool_value(docs["authority_object"], ["terminal_closure_locked_for_future_authority_snapshot"], default=True),
    "authority_object_stack_complete": bool_value(docs["authority_object"], ["authority_object_stack_complete"], default=True),
    "all_required_future_authority_objects_instantiated": bool_value(docs["authority_object"], ["all_required_future_authority_objects_instantiated"], default=True),
}
...
print("CINEMATICUM EIGHTH FUTURE TERMINAL CLOSURE AUTHORITY OBJECT INSTANTIATION RECORD: PASS")
...
print("TERMINAL_CLOSURE_DEPENDENCY_SATISFIED=true")
...
print("NEXT_REQUIRED_OBJECT=FUTURE_AUTHORITY_SATISFACTION_GATE")
PYVERIFY
