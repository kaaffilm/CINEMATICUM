...
PREVIOUS_AUTHORITY_SLOT_ID = "color_grade_lock_authority"
PREVIOUS_AUTHORITY_OBJECT = "COLOR_GRADE_LOCK_AUTHORITY_OBJECT"
PREVIOUS_INSTANTIATION_RECORD_ID = "INST_004_COLOR_GRADE_LOCK_AUTHORITY_OBJECT"

REQUEST_ID = "REQ_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT"
VALIDATION_RECORD_ID = "VAL_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT"
DECISION_RECORD_ID = "DEC_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT"
INSTANTIATION_RECORD_ID = "INST_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT"
AUTHORITY_SLOT_ID = "release_delivery_artifacts_lock_authority"
AUTHORITY_OBJECT = "RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT"

PATHS = {
    "law": Path("CINEMATICUM_FIFTH_FUTURE_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT_INSTANTIATION_RECORD_LAW.json"),
    "status": Path("CASES/CASE_001_THE_LAST_RENDER/FIFTH_FUTURE_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT_INSTANTIATION_RECORD_STATUS.json"),
    "request": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_REQUESTS/REQ_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT.json"),
    "validation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_VALIDATION_RECORDS/VAL_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT.json"),
    "decision": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_DECISION_RECORDS/DEC_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT.json"),
    "instantiation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_INSTANTIATION_RECORDS/INST_005_RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT.json"),
    "authority_object": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECTS/RELEASE_DELIVERY_ARTIFACTS_LOCK_AUTHORITY_OBJECT.json"),
    "previous_instantiation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_INSTANTIATION_RECORDS/INST_004_COLOR_GRADE_LOCK_AUTHORITY_OBJECT.json"),
    "previous_authority_object": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECTS/COLOR_GRADE_LOCK_AUTHORITY_OBJECT.json"),
}
...
expected_counts = {
    ...
    "accepted_authority_object_count": 5,
    "instantiated_authority_object_count": 5,
    "unfilled_authority_object_slot_count": 3,
}
...
print("CINEMATICUM FIFTH FUTURE RELEASE DELIVERY-ARTIFACTS LOCK AUTHORITY OBJECT INSTANTIATION RECORD: PASS")
...
print("ACCEPTED_DECISION_COUNT=5")
print("ACCEPTED_AUTHORITY_OBJECT_COUNT=5")
print("INSTANTIATED_AUTHORITY_OBJECT_COUNT=5")
print("UNFILLED_AUTHORITY_OBJECT_SLOT_COUNT=3")
