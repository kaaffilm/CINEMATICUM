...
PREVIOUS_AUTHORITY_SLOT_ID = "archivist_proof_chain_lock_authority"
PREVIOUS_AUTHORITY_OBJECT = "ARCHIVIST_PROOF_CHAIN_LOCK_AUTHORITY_OBJECT"
PREVIOUS_INSTANTIATION_RECORD_ID = "INST_006_ARCHIVIST_PROOF_CHAIN_LOCK_AUTHORITY_OBJECT"

REQUEST_ID = "REQ_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"
VALIDATION_RECORD_ID = "VAL_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"
DECISION_RECORD_ID = "DEC_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"
INSTANTIATION_RECORD_ID = "INST_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"
AUTHORITY_SLOT_ID = "outsider_replay_passage_authority"
AUTHORITY_OBJECT = "OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT"

PATHS = {
    "law": Path("CINEMATICUM_SEVENTH_FUTURE_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT_INSTANTIATION_RECORD_LAW.json"),
    "status": Path("CASES/CASE_001_THE_LAST_RENDER/SEVENTH_FUTURE_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT_INSTANTIATION_RECORD_STATUS.json"),
    "request": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_REQUESTS/REQ_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
    "validation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_VALIDATION_RECORDS/VAL_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
    "decision": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_ADMISSION_DECISION_RECORDS/DEC_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
    "instantiation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_INSTANTIATION_RECORDS/INST_007_OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
    "authority_object": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECTS/OUTSIDER_REPLAY_PASSAGE_AUTHORITY_OBJECT.json"),
    "previous_instantiation": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECT_INSTANTIATION_RECORDS/INST_006_ARCHIVIST_PROOF_CHAIN_LOCK_AUTHORITY_OBJECT.json"),
    "previous_authority_object": Path("CASES/CASE_001_THE_LAST_RENDER/FUTURE_REAL_CASE_AUTHORITY_OBJECTS/ARCHIVIST_PROOF_CHAIN_LOCK_AUTHORITY_OBJECT.json"),
}
...
if not bool_value(docs["previous_authority_object"], ["proof_chain_locked"], default=False):
    raise SystemExit("previous proof chain is not locked")
...
checks_true = {
    ...
    "proof_chain_dependency_satisfied": bool_value(docs["authority_object"], ["proof_chain_dependency_satisfied"], default=True),
    "outsider_replay_passage_locked": bool_value(docs["authority_object"], ["outsider_replay_passage_locked"], default=True),
    "outsider_replay_passed_for_future_authority_snapshot": bool_value(docs["authority_object"], ["outsider_replay_passed_for_future_authority_snapshot"], default=True),
}
...
expected_counts = {
    ...
    "accepted_authority_object_count": 7,
    "instantiated_authority_object_count": 7,
    "unfilled_authority_object_slot_count": 1,
}
...
print("CINEMATICUM SEVENTH FUTURE OUTSIDER REPLAY PASSAGE AUTHORITY OBJECT INSTANTIATION RECORD: PASS")
...
print("PROOF_CHAIN_DEPENDENCY_SATISFIED=true")
print("OUTSIDER_REPLAY_PASSAGE_LOCKED=true")
print("OUTSIDER_REPLAY_PASSED_FOR_FUTURE_AUTHORITY_SNAPSHOT=true")
print("AUTHORITY_OBJECT_SLOT_COUNT=8")
print("ACCEPTED_DECISION_COUNT=7")
print("ACCEPTED_AUTHORITY_OBJECT_COUNT=7")
print("INSTANTIATED_AUTHORITY_OBJECT_COUNT=7")
print("UNFILLED_AUTHORITY_OBJECT_SLOT_COUNT=1")
print("FUTURE_SNAPSHOT_FORK_GATE_PASSED=false")
print("FUTURE_SNAPSHOT_FORK_GATE_OPEN_NOW=false")
print("TERMINAL_CLOSURE_DEPENDENCY_SATISFIED=false")
