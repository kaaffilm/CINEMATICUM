...
for obj in (gate, law, status):
    ...
    assert obj["authority_object_admission_intake_validation_gate_passed"] is True
    assert obj["intake_validation_gate_passed"] is True
...
print("INTAKE_VALIDATION_GATE_PASSED=true")
