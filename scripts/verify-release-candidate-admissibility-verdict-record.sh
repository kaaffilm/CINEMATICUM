...
obj = json.loads(Path("CINEMATICUM_RELEASE_CANDIDATE_ADMISSIBILITY_VERDICT_RECORD.json").read_text())
...
required_true = [
    ...
    "release_candidate_outsider_replay_passage_record_present",
    ...
    "release_candidate_admissibility_verdict_record_present",
    "admissibility_verdict_record_present",
    "admissibility_verdict_declared",
...
if obj.get("admissibility_verdict_result") != "ADMISSIBLE":
    raise SystemExit("ADMISSIBILITY_VERDICT_RESULT_NOT_ADMISSIBLE")
if obj.get("next_required_object") != "RELEASE_CANDIDATE_TERMINAL_CLOSURE_RECORD":
    raise SystemExit("NEXT_REQUIRED_OBJECT_MISMATCH")

print("CINEMATICUM RELEASE CANDIDATE ADMISSIBILITY VERDICT RECORD: PASS")
...
print(f"ADMISSIBILITY_VERDICT_RESULT={obj['admissibility_verdict_result']}")
