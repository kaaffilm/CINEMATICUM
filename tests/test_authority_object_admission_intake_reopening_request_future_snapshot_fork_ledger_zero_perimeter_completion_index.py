...
FULL = 'AUTHORITY_OBJECT_ADMISSION_INTAKE_REOPENING_REQUEST_FUTURE_SNAPSHOT_FORK_LEDGER_ZERO_PERIMETER_COMPLETION_INDEX'
LABEL = 'ZERO-PERIMETER-COMPLETION-INDEX'

class TestFutureForkLedgerZeroPerimeterCompletionIndex(unittest.TestCase):
