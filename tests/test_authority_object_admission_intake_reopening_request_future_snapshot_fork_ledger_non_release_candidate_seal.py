...
FULL = 'AUTHORITY_OBJECT_ADMISSION_INTAKE_REOPENING_REQUEST_FUTURE_SNAPSHOT_FORK_LEDGER_NON_RELEASE_CANDIDATE_SEAL'
LABEL = 'NON-RELEASE-CANDIDATE'

class TestFutureForkLedgerNonReleaseCandidateSeal(unittest.TestCase):
