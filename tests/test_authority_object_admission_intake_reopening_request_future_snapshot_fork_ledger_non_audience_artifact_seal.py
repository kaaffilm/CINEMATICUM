...
FULL = 'AUTHORITY_OBJECT_ADMISSION_INTAKE_REOPENING_REQUEST_FUTURE_SNAPSHOT_FORK_LEDGER_NON_AUDIENCE_ARTIFACT_SEAL'
LABEL = 'NON-AUDIENCE-ARTIFACT'

class TestFutureForkLedgerNonAudienceArtifactSeal(unittest.TestCase):
